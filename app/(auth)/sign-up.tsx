        ...
        <ScrollView className="flex-1 bg-white">
            <View className="flex-1 bg-white">
                <View className="relative w-full h-[250px]">
                    ...
                    />
                    <Text className="text-2xl text-black font-JakartaSemiBold bottom-5 left-5">Create Your Account</Text>
                </View>
                <View className="p-5">
                    <InputField
                    label="Name"
                    ...
                    />
                    <CustomButton title="Sign Up" onPress={onSignUpPress} className="w-full bg-[#0286ff] mt-6"/>
                    <OAuth/>
                ...
                >
                    <View className="bg-white px-7 py-9 rounded-2xl min-h-[300px]">
                        ...
                        <Text className="font-Jakarta mb-3">We've sent a verification code to {form.email}</Text>
                        <InputField
                        label="Code"
                        icon={icons.lock}
                        placeholder="123456"
                        ...
                        className="w-full bg-success-500 mt-5"
                        />
                    </View>
                </ReactNativeModal>
                <ReactNativeModal isVisible={showSuccessModal}>
                    <View className="bg-white px-7 py-9 rounded-2xl min-h-[300px]">
                        <Image source={images.check} className="w-[110px] h-[110px] mx-auto my-3"/>
                        ...
                        <CustomButton title="Continue" className="mt-5 w-full"
                        onPress={()=>{
